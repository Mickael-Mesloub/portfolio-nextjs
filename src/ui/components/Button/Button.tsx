...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md font-antonSC text-sm font-medium transition-colors cursor-pointer focus-visible:ring-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none hover:opacity-75 dark:hover:opacity-90 gap-2 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
